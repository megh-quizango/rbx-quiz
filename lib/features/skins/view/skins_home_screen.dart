          ...
          child: ListView(
            ...
            children: [
                ...
                children: [
                  Expanded(
                    child: _CategoryCard(
                      ...
                      onTap: () => context.push('/skins/list/all_character'),
                    ),
                  ),
                  ...
                  Expanded(
                    child: _CategoryCard(
                      ...
                      onTap: () => context.push('/skins/node/animations'),
                    ),
                  ),
                ],
              ),
                ...
                children: [
                  Expanded(
                    child: _CategoryCard(
                      ...
                      onTap: () => context.push('/skins/node/accesories'),
                    ),
                  ),
                  const SizedBox(width: 14),
                  Expanded(
                    child: _CategoryCard(
                      ...
                      onTap: () => context.push('/skins/node/all_clothing'),
                    ),
                  ),
                ],
              ),
              ...
              _CategoryCard(
                ...
                onTap: () => context.push('/skins/node/head_body'),
                wide: true,
              ),
            ],
          ),
